                            ...
                            <div class="card product-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="Cartservlet" method="post">
                                        ...
                                        <button class="btn custom-bg text-white" name="cart" onclick="addToCart(<%=products.getpId()%>,'<%=products.getpName()%>',<%=products.getPriceAfterApplyingDiscount()%>) " value="<%=products.getpId()%>"  >Add to Cart</button>
