                    ...
                    <div class="col-md-12">
                        <div class="card-columns">
                            ...
                            <div class="card product-card">
                                ...
                                <center> <img class="card-img-top m-2" style="max-height: 200px; max-width: 95%;width: auto;" src="img/product/<%=products.getpPhoto()%>" alt="Card image cap"></center>
                                
                                
                                <div class="card-body">
                                    <h5 class="card-title"><%=products.getpName() %></h5>
                                    <p class="card-text"> <%= products.getpDesc() %></p>
                                    ...
                                    <form action="Cartservlet" method="post">
                                        ...
                                        <button class="btn custom-bg text-white" name="cart" onclick="addToCart(<%=products.getpId()%>,'<%=products.getpName()%>',<%=products.getpPrice()%>) " value="<%=products.getpId()%>"  >Add to Cart</button>
                                        <button class="btn btn-outline-success"> &#8377;<%=products.getpPrice() %></button>
                                    </div>   
                                    </form>
